...
if __name__ == "__main__":
    ...
    #     prompt_inputs_spec={
    #         "height": "Athelete's height in cm",
    #         "weight": "Athelete's weight in kg",
    #         "goal": "Goal of the athelete",
    #         "restrictions": "Dietry restrictions of the athelete's"
    #     },
    ...
    def run_prompt(prompt_inputs):
        ...
        #         - Dietry restrictions: {prompt_inputs["restrictions"]}
        # """
        # Prompt v2
        prompt = f"""
        ...
        <sampleInput>
                height: 178
                weight: 85
                goal: Build muscle mass while maintaining cardiovascular fitness
                restrictions: Vegetarian, lactose intolerant
        </sampleInput>

        <idealOutput>
                # One-Day Muscle-Building Meal Plan
                ## For 178cm, 85kg Vegetarian Athlete (Lactose Intolerant)
                ...
                - **Carbohydrates:** 350g (50% of calories)
                ...
                **Nutrition:** 550 cal | 18g protein | 72g carbs | 18g fat

                ---

                ## MID-MORNING SNACK | 10:00 AM
                **Protein Smoothie**
                - Dairy-free protein powder: 30g
                - Mixed berries (frozen): 100g
                - Coconut milk: 150ml
                - Almonds: 25g

                **Nutrition:** 280 cal | 25g protein | 24g carbs | 9g fat
                ...
                **Chickpea & Quinoa Buddha Bowl**
                ...
                - Cucumber: 120g
                - Olive oil drizzle: 15ml
                - Tahini dressing: 20g

                **Nutrition:** 620 cal | 22g protein | 78g carbs | 20g fat
                ...
                **Nutrition:** 310 cal | 12g protein | 38g carbs | 12g fat

                ---

                ## DINNER | 7:00 PM
                **Lentil & Sweet Potato Buddha Bowl**
                - Cooked red lentils: 200g
                - Roasted sweet potato: 250g
                - Kale: 100g
                - Coconut oil: 10ml
                - Pumpkin seeds: 20g
                - Lemon juice & garlic seasoning

                **Nutrition:** 580 cal | 23g protein | 82g carbs | 12g fat
                ...
                **Nutrition:** 280 cal | 10g protein | 28g carbs | 14g fat
                ...
                ## Key Notes
                ✓ All dairy-free (uses plant-based milks & tahini instead of cheese)  
                ✓ High protein from legumes, nuts, seeds, and plant-based powder  
                ✓ Balanced for muscle growth + cardiovascular health  
                ✓ Budget-friendly protein sources (lentils, chickpeas, oats, peanut butter)
        </idealOutput>
        <whyThisIsIdeal>
                This output is ideal because:
                - Meets all mandatory requirements: appropriate calories/macros for the profile
                - All dietary restrictions respected with thoughtful plant-based alternatives
                - Balanced approach to muscle and cardio goals
                - Realistic, accessible ingredients that fit the budget
                - Vegetarian protein sources (legumes, nuts, seeds, powder) are adequate
                - All dairy excluded with clear alternatives
                - Provides specific meal times and portion sizes in grams
        </whyThisIsIdeal>
